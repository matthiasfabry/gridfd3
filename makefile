...
fd3 : src/fd3/fd3fpolis.o src/fd3/fd3sep.o src/fd3/triorb.o src/kepler.o src/mxfuns.o
	${CC} -Wall src/fd3/fd3fpolis.o src/fd3/fd3sep.o src/fd3/triorb.o src/kepler.o src/mxfuns.o \
	-lgsl -lgslcblas -lm -o bin/$@